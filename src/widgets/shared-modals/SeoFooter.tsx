...
export function SeoFooter() {
    ...
    const tags = ["실시간 청산", "고래 거래", "트리맵", "김치프리미엄", "모의투자", "펀딩비", "차트분석", "코인랭킹", "무료"];
            ...
            <div className="mx-auto w-full max-w-screen-xl px-5 py-10">
                ...
                <div className="flex items-start gap-4 mb-8">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className={`text-xs leading-relaxed mb-3 ${bodyColor}`}>코인 트레이더를 위한 올인원 대시보드</p>
                ...
                <div className={`mt-8 pt-5 border-t ${borderColor} flex flex-col gap-1 md:flex-row md:items-center md:justify-between`}>
                    ...
                    <div className={`flex items-center gap-3 shrink-0 md:ml-4 text-[11px] ${taglineColor}`}>
                        {/* 운영자·데이터 출처·문의처를 밝히는 곳 */}
                        <Link href="/about" className="hover:text-zinc-300 transition-colors whitespace-nowrap">
                            소개·문의
                        </Link>
                        <span>·</span>
                        <Link href="/privacy" className="hover:text-zinc-300 transition-colors whitespace-nowrap">개인정보처리방침</Link>
                        <span>·</span>
                        <Link href="/terms" className="hover:text-zinc-300 transition-colors whitespace-nowrap">이용약관</Link>
                        <span>·</span>

...
export const metadata: Metadata = {
    ...
    description:
        "바이낸스 실시간 청산 현황, 고래 거래 추적, 150개 코인 트리맵, 김치프리미엄, 공포탐욕지수를 한 화면에서 무료로 확인하세요.",
    keywords: [
        "코인 청산 현황 실시간", "비트코인 청산 현황", "코인 고래 거래 실시간",
        "김치프리미엄 오늘", "김치프리미엄 실시간", "업비트 바이낸스 가격 차이",
        "코인 공포탐욕지수 오늘", "공포탐욕지수 실시간", "코인 트리맵 실시간",
...
const APP_JSONLD = {
    ...
    description:
        "비트코인 모의투자와 실시간 시장 분석 대시보드. 바이낸스 실시간 청산, 고래 거래, 코인 트리맵, 김치프리미엄, 공포탐욕지수, 코인 선물 모의투자를 무료로 제공합니다.",
    offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "KRW",
...
const SOFTWARE_JSONLD = {
    ...
    operatingSystem: "Web Browser",
    description:
        "비트코인 모의투자를 무료로 제공하는 실시간 코인 트레이딩 대시보드. 바이낸스 가격 기반 선물 모의거래, 실시간 청산, 고래 거래 추적.",
    offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "KRW",
...
const FAQ_JSONLD = {
    ...
    mainEntity: [
        ...
        {
            "@type": "Question",
            name: "비트코인 모의투자를 할 수 있나요?",
            acceptedAnswer: {
                "@type": "Answer",
                text: "네, TradeHub에서 비트코인 모의투자를 무료로 이용할 수 있습니다. 실시간 바이낸스 비트코인 가격을 기반으로 가상 자금 10,000 USDT로 비트코인 선물 모의거래를 연습할 수 있으며, 최대 125배 레버리지, 롱/숏 포지션, 다양한 주문 유형을 지원합니다.",
            },
        },
    ],
};

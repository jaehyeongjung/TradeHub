        ...
        <div className="min-h-screen bg-neutral-950 text-white selection:bg-[#02C076] selection:text-black font-sans tracking-tight antialiased">
            ...
            <nav className="fixed top-0 z-[100] flex w-full items-center justify-between px-6 py-8 md:px-12 md:py-10">
                <div className="flex items-baseline gap-3">
                    ...
                    <span className="text-[10px] font-semibold text-[#02C076] tracking-widest uppercase">
                        Beta
                    </span>
                </div>
                <Link
            ...
            <main className="relative mx-auto max-w-[1600px] px-6 md:px-12">
                ...
                <section className="relative flex min-h-screen flex-col items-start justify-center pt-20">
                    ...
                    <div className="mt-16 ml-2 max-w-2xl">
                        <p className="text-xl md:text-2xl font-medium leading-[1.5] tracking-tight text-neutral-500">
                            실전 그대로,{" "}
                    ...
                    <div className="mt-24 w-full flex flex-col md:flex-row items-start md:items-end justify-between gap-10">
                        <Link
                            href="/trading"
                ...
                {/* Section 2: Grid */}
                <section className="py-32 grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div className="col-span-1 md:col-span-7 bg-neutral-900 p-12 md:p-20 flex flex-col justify-between min-h-[560px] rounded-3xl">
                        <span className="text-xs font-semibold tracking-[0.3em] text-[#02C076] uppercase">
                            01 / Precision
                        </span>
                        <h2 className="text-5xl md:text-7xl font-black tracking-[-0.06em] leading-none mt-10">
                            TICK-BY-TICK
                            <br />
                            SYNC.
                        </h2>
                        <p className="mt-10 text-base md:text-lg font-medium text-neutral-500 leading-relaxed">
                    ...
                    <div className="col-span-1 md:col-span-5 flex flex-col gap-2">
                        <div className="flex-1 bg-neutral-900 p-10 flex flex-col justify-between rounded-3xl group">
                        ...
                        <div className="flex-1 bg-neutral-900 p-10 flex flex-col justify-between rounded-3xl">
                            <span className="text-xs font-semibold tracking-[0.3em] text-neutral-600 uppercase">
                                03 / Freedom
                            </span>
                            <div>
                ...
                {/* Section 3: Features */}
                <section className="py-32 flex flex-col md:flex-row gap-20 items-start">
                    <div className="md:w-1/3 sticky top-40">
                        <h2 className="text-4xl font-black tracking-[-0.06em] leading-tight">
                            실전과 동일한 <br />
...
function FeatureRow({ title, desc }: { title: string; desc: React.ReactNode }) {
    return (
        <div className="group border-b border-neutral-800 pb-10 transition-colors duration-300 hover:border-neutral-700">
            <h3 className="text-2xl font-black tracking-tight group-hover:text-[#02C076] transition-colors duration-300">
                {title}
            </h3>
            <p className="mt-4 text-base font-medium text-neutral-500 leading-relaxed max-w-xl group-hover:text-neutral-400 transition-colors duration-300">
                {desc}
            </p>
        </div>
    );

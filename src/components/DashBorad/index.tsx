...
export const DashBoard = () => {
    ...
    return (
        <>
            <div className="flex gap-5 mt-5 min-h-130 h-[calc(100vh-400px)] lg:h-[calc(100vh-200px)]">
                {/* 왼쪽: 게시판/뉴스 카드 */}
                <div className="min-w-113 w-full h-full border-2 rounded-2xl flex flex-col gap-3 p-3 bg-neutral-950">
                    {/* 상단 바: 탭 + (우측) 글쓰기 버튼 */}
                ...
                <div className="min-w-105 border-2 rounded-2xl flex flex-col items-center gap-3 h-[calc(100vh-400px)]  lg:h-[calc(100vh-200px)] bg-neutral-950">
                    <Chat />
                </div>
            </div>
            <SeoFooter />

        ...
        <div className="h-full flex flex-col p-3 text-white ">
            ...
            <div className="mb-3 rounded-xl border border-neutral-700 bg-neutral-900/80 p-3 space-y-2 shadow-lg">
                ...
                <div className="relative w-full h-[10px] rounded-full overflow-hidden">
                    ...
                    <motion.div
                        className="absolute left-0 top-0 bottom-0 mb-[px] bg-emerald-500"
                        initial={{ width: 0 }}
                        animate={{ width: `${longPct}%` }}
                        transition={{ duration: 0.45 }}
                    />
                    {ratio.total === 0 && (
                        <div className="pointer-events-none absolute inset-0 flex items-center justify-center text-[11px] font-bold text-neutral-500">
                            아직 투표가 없습니다
                        </div>
                    )}
                </div>
            ...
            >
                {msgs.map((m) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="text-[13px] border border-neutral-800 rounded-lg px-3 py-2 bg-neutral-900 shadow-sm"
                        >
                            ...
                            <span className="text-neutral-300 text-[13px] whitespace-pre-wrap">
                                {m.content}
                            </span>
                        </motion.div>
                    );
                ...
                {!msgs.length && (
                    <div className="text-[12px] text-neutral-500 text-center py-4">
                        아직 메시지가 없습니다. 오늘의 첫 포지션을 잡고 메시지를
                        남겨보세요!
                    </div>
                )}
            </div>
            ...
            <div className="border-t border-neutral-800 pt-1">
                <div className="flex gap-2">
                    <input
                        ...
                        onKeyDown={onKeyDown}
                        className="flex-1 border border-neutral-700 px-3 py-2 rounded-lg bg-neutral-900 text-gray-100 placeholder-neutral-500 focus:outline-none focus:border-green-500 text-[14px] shadow-inner"
                        placeholder={
                            userId
                                ? "포지션에 맞는 생각을 공유해보세요 (최대 2000자)"

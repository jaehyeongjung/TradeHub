    ...
    return (
        ...
        >
            <div className="mx-auto w-full max-w-screen-xl px-5 py-8 text-zinc-300">
                ...
                >
                    코인 선물 커뮤니티, 실시간 포지션과 롱숏 비율을 한 화면에서
                </h2>
                <p className="mt-5 text-sm md:text-base">
                    ...
                    <span className="text-amber-400">바이낸스</span> 글로벌·Top 트레이더 포지션 비율을 비교하고, 시장
                    흐름을 한눈에 파악할 수 있습니다.
                </p>

                <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
                    <article className="rounded-xl bg-zinc-900/60 p-4 ring-1 ring-zinc-800">

...
export function KakaoShareButton({ className = "" }: { className?: string }) {
    ...
    return (
        <button
            ...
            className={`flex cursor-pointer items-center gap-1.5 rounded-chip bg-[#FEE500] px-3 py-2.5 text-footnote font-bold text-[#191919] transition-opacity hover:opacity-85 active:opacity-70 ${className}`}
        >
